...
- **MINOR** — new article added within an existing top-level section; new subsection (e.g. `kubernetes/networking/`) also counts as minor; adding a translation of an existing article to a new language also counts as minor
